    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.patients.update", [$patient->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" type="number" name="weight" id="weight" value="{{ old('weight', $patient->weight) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('height') ? 'is-invalid' : '' }}" type="number" name="height" id="height" value="{{ old('height', $patient->height) }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('smoking') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="smoking" id="smoking" value="1" {{ $patient->smoking || old('smoking', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('blood_type') ? 'is-invalid' : '' }}" name="blood_type" id="blood_type">
                    ...
                    @foreach(App\Models\Patient::BLOOD_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('blood_type', $patient->blood_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('avg_blood_pressure') ? 'is-invalid' : '' }}" type="text" name="avg_blood_pressure" id="avg_blood_pressure" value="{{ old('avg_blood_pressure', $patient->avg_blood_pressure) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identity_number') ? 'is-invalid' : '' }}" type="text" name="identity_number" id="identity_number" value="{{ old('identity_number', $patient->identity_number) }}">
